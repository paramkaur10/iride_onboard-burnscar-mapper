convolution_layer_vocabulary = {
    ...
    'm': 'MBConv',
    'n': 'MBConvNoRes',
    'o': 'CSPConvBlock',      # re-enabled for search-space diversity (quant-robustness study)
    'p': 'CSPMBConvBlock',    # re-enabled for search-space diversity (quant-robustness study)
    'R': 'ResNetBlock',
